...
int example_spi_receive_dma(void)
{
    int      ret = 0;
    ...
    ret = csi_spi_receive_async(&spi_master, master_rx_data, TEST_STR_LENGTH);
...
int main(void)
{
    ...
    printf("\n\n\n");
    printf("-------------------------------------\n");
    printf("example_spi_receive_dma()\n");
    printf("-------------------------------------\n");
    example_spi_receive_dma();
