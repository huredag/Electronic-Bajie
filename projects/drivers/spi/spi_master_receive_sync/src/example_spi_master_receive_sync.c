...
csi_spi_event_t spi_master_event;
csi_spi_t spi_master;
...
int example_spi_receive_sync(void)
{
    ...
    ret = csi_spi_baud(&spi_master, 5000000);
    ...
    ret = csi_spi_receive(&spi_master, master_rx_data, TEST_STR_LENGTH, -1);
...
int main(void)
{
    ...
    printf("\n\n\n");
    printf("-------------------------------------\n");
    printf("example_spi_receive_sync()\n");
    printf("-------------------------------------\n");
    example_spi_receive_sync();
