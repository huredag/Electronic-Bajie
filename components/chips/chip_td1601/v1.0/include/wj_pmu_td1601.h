...
#define WJ_LPCR_MODE_SEL_Pos                      (7U)
#define WJ_LPCR_MODE_SEL_Msk                      (0x1U << WJ_LPCR_MODE_SEL_Pos)
...
#define WJ_IP_CTRL_TDM_I2S_MONO_Pos               (18U)
#define WJ_IP_CTRL_TDM_I2S_MONO_Msk               (0x3U << WJ_IP_CTRL_TDM_I2S_MONO_Pos)

#define WJ_IP_CTRL_TDM_ENABLE_Pos                 (17U)
#define WJ_IP_CTRL_TDM_ENABLE_Msk                 (0x1U << WJ_IP_CTRL_TDM_ENABLE_Pos)
...
static inline void wj_pmu_mode_1(wj_pmu_reg_t *pmu_base)
{
    pmu_base->LPCR |= WJ_LPCR_MODE_SEL_Msk;
}
...
static inline void wj_ip_ctrl_tdm_i2s_mono_disable(wj_pmu_reg_t *pmu_base)
{
    pmu_base->IP_CTRL &= ~WJ_IP_CTRL_TDM_I2S_MONO_Msk;
}

static inline void wj_ip_ctrl_tdm_enable(wj_pmu_reg_t *pmu_base)
{
    pmu_base->IP_CTRL |= WJ_IP_CTRL_TDM_ENABLE_Msk;
}

static inline void wj_ip_ctrl_tdm_disable(wj_pmu_reg_t *pmu_base)
{
    pmu_base->IP_CTRL &= ~WJ_IP_CTRL_TDM_ENABLE_Msk;
}
