...
struct csi_qspi {
    ...
    csi_error_t (*send)(csi_qspi_t *qspi, csi_qspi_command_t *cmd, const void *data, uint32_t size); ///< The send_async func
    csi_error_t (*receive)(csi_qspi_t *qspi, csi_qspi_command_t *cmd, void *data, uint32_t size);    ///< The receive_async func
    csi_error_t (*send_receive)(csi_qspi_t *qspi, csi_qspi_command_t *cmd,const void *data_out, void *data_in, uint32_t size); ///< The send_receive_async func
